...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ImportanceBlockDTO_allOf")]
    public partial class ImportanceBlockDTOAllOf : IEquatable<ImportanceBlockDTOAllOf>, IValidatableObject
    {
        ...
        public ImportanceBlockDTOAllOf(long votingEligibleAccountsCount = default(long), string harvestingEligibleAccountsCount = default(string), string totalVotingBalance = default(string), string previousImportanceBlockHash = default(string))
        {
            ...
            {
                throw new ArgumentNullException("harvestingEligibleAccountsCount is a required property for ImportanceBlockDTOAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalVotingBalance is a required property for ImportanceBlockDTOAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("previousImportanceBlockHash is a required property for ImportanceBlockDTOAllOf and cannot be null");
            }
