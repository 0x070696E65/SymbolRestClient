...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BalanceTransferReceiptDTO_allOf")]
    public partial class BalanceTransferReceiptDTOAllOf : IEquatable<BalanceTransferReceiptDTOAllOf>, IValidatableObject
    {
        ...
        public BalanceTransferReceiptDTOAllOf(string mosaicId = default(string), string amount = default(string), string senderAddress = default(string), string recipientAddress = default(string))
        {
            ...
            if (mosaicId == null)
            {
                throw new ArgumentNullException("mosaicId is a required property for BalanceTransferReceiptDTOAllOf and cannot be null");
            }
            this.MosaicId = mosaicId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for BalanceTransferReceiptDTOAllOf and cannot be null");
            }
            this.Amount = amount;
            // to ensure "senderAddress" is required (not null)
            if (senderAddress == null)
            {
                throw new ArgumentNullException("senderAddress is a required property for BalanceTransferReceiptDTOAllOf and cannot be null");
            }
            this.SenderAddress = senderAddress;
            // to ensure "recipientAddress" is required (not null)
            if (recipientAddress == null)
            {
                throw new ArgumentNullException("recipientAddress is a required property for BalanceTransferReceiptDTOAllOf and cannot be null");
            }
