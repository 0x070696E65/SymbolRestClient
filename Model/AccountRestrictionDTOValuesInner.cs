...
namespace SymbolRestClient.Model
{
    ...
    public partial class AccountRestrictionDTOValuesInner : AbstractOpenAPISchema, IEquatable<AccountRestrictionDTOValuesInner>, IValidatableObject
    {
        /// <summary>
        ...
        public AccountRestrictionDTOValuesInner(TransactionTypeEnum actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "anyOf";
            this.ActualInstance = actualInstance != null ? actualInstance : throw new ArgumentException("Invalid instance found. Must not be null.");
            // this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        }
