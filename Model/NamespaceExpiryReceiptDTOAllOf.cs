...
namespace SymbolRestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NamespaceExpiryReceiptDTO_allOf")]
    public partial class NamespaceExpiryReceiptDTOAllOf : IEquatable<NamespaceExpiryReceiptDTOAllOf>, IValidatableObject
    {
        ...
        public NamespaceExpiryReceiptDTOAllOf(string artifactId = default(string))
        {
            ...
            if (artifactId == null)
            {
                throw new ArgumentNullException("artifactId is a required property for NamespaceExpiryReceiptDTOAllOf and cannot be null");
            }
